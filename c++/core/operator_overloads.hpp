...
namespace enc
{
  ...
  // inline bool operator==(const Combatant &lhs, const Combatant *rhs) { return rhs && lhs._instanceId == rhs->_instanceId; }

  // inline bool operator==(const Combatant *lhs, const Combatant &rhs) { return lhs && lhs->_instanceId == rhs._instanceId; }
