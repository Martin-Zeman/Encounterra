...
namespace enc
{
  const std::unordered_map<SpellTarget, int> TRANSLATE_RADIUS
    = {{SpellTarget::RADIUS_5, 1}, {SpellTarget::RADIUS_10, 2}, {SpellTarget::RADIUS_15, 3}, {SpellTarget::RADIUS_20, 4}, {SpellTarget::RADIUS_30, 6}};
  ...
  const std::unordered_map<SpellTarget, int> TRANSLATE_BOX 
    = {{SpellTarget::BOX_5, 1}, {SpellTarget::BOX_15, 3}, {SpellTarget::BOX_20, 4}, {SpellTarget::BOX_30, 6}};
}