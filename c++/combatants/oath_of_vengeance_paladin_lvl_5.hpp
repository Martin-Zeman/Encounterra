...
namespace enc
{
  class OathOfVengeancePaladinLvl5 : public Combatant
  {
  public:
    OathOfVengeancePaladinLvl5(int num);
    OathOfVengeancePaladinLvl5(const std::string &name);
  ...
  private:
    static constexpr std::string_view _className = "Oath of Vengeance Paladin LVL 5";
