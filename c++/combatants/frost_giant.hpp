...
namespace enc
{
  ...
  class FrostGiant : public Combatant
  {
  public:
    FrostGiant(int num);
    FrostGiant(const std::string &name);
  ...
  private:
    static constexpr std::string_view _className = "Frost Giant";
    static constexpr int _classLevel = 8;
