...
namespace enc
{
  ...
  class CultistFanatic : public Combatant
  {
  public:
    CultistFanatic(int num);
    CultistFanatic(const std::string &name);
  ...
  private:
    static constexpr std::string_view _className = "Cultist Fanatic";
