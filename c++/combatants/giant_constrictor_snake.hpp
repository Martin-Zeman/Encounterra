...
namespace enc
{
  ...
  class GiantConstrictorSnake : public Combatant
  {
  public:
    GiantConstrictorSnake(int num);
    GiantConstrictorSnake(const std::string &name);
  ...
  private:
    static constexpr std::string_view _className = "Giant Constrictor Snake";
