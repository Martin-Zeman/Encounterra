...
namespace enc
{
  ...
  class WildHeartBarbarianLvl4 : public Combatant
  {
  public:
    WildHeartBarbarianLvl4(int num);
    WildHeartBarbarianLvl4(const std::string &name);
  ...
  private:
    static constexpr std::string_view _className = "Wild Heart Barbarian LVL 4";
