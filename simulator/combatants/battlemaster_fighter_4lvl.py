...
class BattlemasterFighter4Lvl(Combatant):
    ...
    def __init__(self, num_or_name=1):
        ...
        self.greatsword = self.add_ability(Action.MELEE_ATTACK,  name="Greatsword", combatant=self, to_hit=6, dmg_dice="2d6", dmg_bonus=4, dmg_type=DamageType.Slashing, attack_range=1, two_handed=True)
        self.handaxe = self.add_ability(Action.RANGED_ATTACK, name="Handaxe", combatant=self, to_hit=6, dmg_dice="1d6", dmg_bonus=4, dmg_type=DamageType.Slashing, attack_range=12, crit_range=1, uses_dex=False, ammo=Uses(2, ResourceRefreshType.NEVER))
        self.add_ability(Reaction.REACTION_ATTACK,  name="Greatsword", combatant=self, to_hit=6, dmg_dice="2d6", dmg_bonus=4, dmg_type=DamageType.Slashing, attack_range=1, two_handed=True)
