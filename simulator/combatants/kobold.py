...
class Kobold(Combatant):
    ...
    def __init__(self, num_or_name=1):
        ...
        self.dagger = self.add_ability(Action.MELEE_ATTACK,  name="Dagger", combatant=self, to_hit=4, dmg_dice="1d4", dmg_bonus=2, dmg_type=DamageType.Piercing, attack_range=1, crit_range=1, uses_dex=True)
        self.sling = self.add_ability(Action.RANGED_ATTACK,  name="Sling", combatant=self, to_hit=4, dmg_dice="1d4", dmg_bonus=2, dmg_type=DamageType.Bludgeoning, attack_range=24, crit_range=1)
