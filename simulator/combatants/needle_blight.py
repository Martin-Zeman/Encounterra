...
class NeedleBlight(Combatant):
    ...
    def __init__(self, num_or_name=1):
        ...
        self.needles = self.add_ability(Action.RANGED_ATTACK, name="Needles", combatant=self, to_hit=4, dmg_dice="2d6", dmg_bonus=1, dmg_type=DamageType.Piercing, attack_range=12, crit_range=1, ammo=Uses(math.inf, ResourceRefreshType.NEVER))
