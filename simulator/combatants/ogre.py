...
class Ogre(Combatant):
    ...
    def __init__(self, num_or_name=1):
        ...
        self.javelin_attack = self.add_ability(Action.RANGED_ATTACK,  name="Javelin", combatant=self, to_hit=6, dmg_dice="2d6", dmg_bonus=4, dmg_type=DamageType.Piercing, attack_range=24, crit_range=1, ammo=Uses(1, ResourceRefreshType.NEVER), uses_dex=False)
