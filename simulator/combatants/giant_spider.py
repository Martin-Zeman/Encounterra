...
class GiantSpider(Combatant):
    ...
    def __init__(self, effect_tracker, name="Giant Spider"):
        super().__init__(effect_tracker, name, level=1, hp=26, ac=14, init_bonus=3, spell_to_hit=0, speed=30, resistances=set(), dc=0)
