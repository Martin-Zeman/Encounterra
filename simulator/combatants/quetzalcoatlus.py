...
class Quetzalcoatlus(Combatant):
    ...
    def __init__(self, num_or_name=1):
        ...
        self.size = Size.HUGE
        self.bite = self.add_ability(Action.MELEE_ATTACK,  name="Bite", combatant=self, to_hit=4, dmg_dice=((3, 6),), dmg_bonus=2, dmg_type=DamageType.Piercing, attack_range=2, crit_range=1)
        self.add_ability(Reaction.REACTION_ATTACK,  name="Bite", combatant=self, to_hit=4, dmg_dice=((3, 6),), dmg_bonus=2, dmg_type=DamageType.Piercing, attack_range=2, crit_range=1)
