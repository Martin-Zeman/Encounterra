...
class Goblin(Combatant):
    ...
    def __init__(self, num_or_name=1):
        ...
        self.scimitar = self.add_ability(Action.MELEE_ATTACK,  name="Scimitar", combatant=self, to_hit=4, dmg_dice=((1, 6),), dmg_bonus=2, dmg_type=DamageType.Slashing, attack_range=1, crit_range=1, uses_dex=True)
        ...
        self.add_ability(Reaction.REACTION_ATTACK,  name="Scimitar", combatant=self, to_hit=4, dmg_dice=((1, 6),), dmg_bonus=2, dmg_type=DamageType.Slashing, attack_range=1, crit_range=1)
