...
class Skeleton(Combatant):
    ...
    def __init__(self, num_or_name=1):
        ...
        self.shortsword = self.add_ability(Action.MELEE_ATTACK,  name="Shortsword", combatant=self, to_hit=4, dmg_dice="1d6", dmg_bonus=2, dmg_type=DamageType.Slashing, attack_range=1, crit_range=1)
        ...
        self.add_ability(Reaction.REACTION_ATTACK,  name="Shortsword", combatant=self, to_hit=4, dmg_dice="1d6", dmg_bonus=2, dmg_type=DamageType.Slashing, attack_range=1, crit_range=1)
