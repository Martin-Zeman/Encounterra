...
class Owlbear(Combatant):
    ...
    def __init__(self, num_or_name=1):
        ...
        self.beak = self.add_ability(Action.MELEE_ATTACK,  name="Beak", combatant=self, to_hit=7, dmg_dice="1d10", dmg_bonus=5, dmg_type=DamageType.Piercing, attack_range=1, crit_range=1)
        self.claws = self.add_ability(Action.MELEE_ATTACK,  name="Claws", combatant=self, to_hit=7, dmg_dice="2d8", dmg_bonus=5, dmg_type=DamageType.Slashing, attack_range=1, crit_range=1)
        self.add_ability(Reaction.REACTION_ATTACK,  name="Claws", combatant=self, to_hit=7, dmg_dice="2d8", dmg_bonus=5, dmg_type=DamageType.Slashing, attack_range=1, crit_range=1)
