...
from simulator.misc import DamageType, SavingThrow, Size, SkillCheck, Class
import logging
...
class GiantConstrictorSnake(Combatant):
    ...
    def __init__(self, name="Giant Constrictor Snake"):
        super().__init__(name, Class.MONSTER.BEAST, level=1, hp=60, ac=12, init_bonus=2, spell_to_hit=0, speed=30, resistances=set(), dc=0)
        self.size = Size.HUGE
