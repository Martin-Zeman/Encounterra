...
class Orc(Combatant):
    ...
    def __init__(self, num_or_name=1):
        ...
        self.add_ability(Reaction.REACTION_ATTACK,  name="Greataxe", combatant=self, to_hit=5, dmg_dice="1d12", dmg_bonus=3, dmg_type=DamageType.Slashing, attack_range=1, crit_range=1)
