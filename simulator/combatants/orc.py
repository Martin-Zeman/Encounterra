...
class Orc(Combatant):
    ...
    def __init__(self, num_or_name=1):
        super().__init__(num_or_name, hp=15, ac=13, init_bonus=1, spell_to_hit=0, speed=30, resistances=set(), dc=0)
        ...
        self.add_ability(BonusAction.AGGRESSIVE)
    ...
    def build_attack_fms(self):
        ...
        self.attack_fsm.add_transition(str(self.greataxe[1]), '0', 'nop')  # Melee
