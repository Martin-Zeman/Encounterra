...
class Zombie(Combatant):
    ...
    def __init__(self, num_or_name=1):
        ...
        self.slam = self.add_ability(Action.MELEE_ATTACK,  name="Slam", combatant=self, to_hit=3, dmg_dice=((1, 6),), dmg_bonus=1, dmg_type=DamageType.Bludgeoning, attack_range=1, crit_range=1)
        self.add_ability(Reaction.REACTION_ATTACK,  name="Slam", combatant=self, to_hit=3, dmg_dice=((1, 6),), dmg_bonus=1, dmg_type=DamageType.Bludgeoning, attack_range=1, crit_range=1)
