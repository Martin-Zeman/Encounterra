...
def test_haste(battle_map, teams, effect_tracker, test_draconic_sorcerer_5lvl, test_bugbear, test_totem_barbarian):
    ...
    try:
        ...
        assert str(actoid1) == "Morningstar on Totem Barbarian 5Lvl 1" or str(actoid2) == "Morningstar on Totem Barbarian 5Lvl 1"
        assert str(actoid1) == "Hasted Morningstar on Totem Barbarian 5Lvl 1" or str(actoid2) == "Hasted Morningstar on Totem Barbarian 5Lvl 1"
