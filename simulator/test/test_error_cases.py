...
def test_error_case_26(battle_map, teams, effect_tracker, test_stone_giant, test_assassin_rogue, test_dire_wolf):
    """
    ...
    and dash back instead of hiding and attacking.
    """
    CustomLogger(LogLevel.WARNING)
    battle_map.set_effect_tracker(effect_tracker)
