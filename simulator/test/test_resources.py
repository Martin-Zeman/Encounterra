...
def test_use_resources_spellslots(battle_map, teams, effect_tracker, test_draconic_sorcerer_5lvl, test_goblin):
    ...
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=2) == 3
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=1) == 4
    use_resources(test_draconic_sorcerer_5lvl, firebolt)
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=3) == 2
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=2) == 3
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=1) == 4
    use_resources(test_draconic_sorcerer_5lvl, fireball)
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=3) == 1
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=2) == 3
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=1) == 4
    use_resources(test_draconic_sorcerer_5lvl, fireball)
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=3) == 0
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=2) == 3
    assert test_draconic_sorcerer_5lvl.spellslots.has_resource(level=1) == 4
