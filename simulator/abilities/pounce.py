from simulator.actions.action_types import HasteAction, Action
...
class PounceFactory(DirectThreatFactory):
    ...
    def __init__(self, combatant, primary_attack, secondary_attack, distance, action_type):
...
class Pounce(Actoid, DirectThreat):
    ...
    def __str__(self):
        return ("Hasted " if isinstance(self.factory.action_type, HasteAction) else "") + f"Pounce on {self.target_combatant}"
