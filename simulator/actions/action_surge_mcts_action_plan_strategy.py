...
from ..actions.action_selector import build_action_dag

logger = logging.getLogger("Encounterra")


class ActionSurgeMCTSActionPlanStrategy(DefaultMCTSActionPlanStrategy):
    ...
    def calculate_action_plan(self, distances, shortest_paths):
        ...
        if dag is None:
            ...
            return None
        best_sequence = get_best_mcts_movement_and_action(self.combatant, dag, distances, shortest_paths, transition_name_to_action, transition_to_eligible_coords, movement_trans_to_coord_and_type)
