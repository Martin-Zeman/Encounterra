...
class Hide(Actoid, CombatantEffect, AttackThreatModifier):
    ...
    def calculate_threat_for_attack(self, combatant, attack, *args, **kwargs):
        ...
        """
        if FactoryFlags.IS_ATTACK_LIKE in attack.factory.flags or (FactoryFlags.IS_FINESSE in attack.factory.flags or FactoryFlags.IS_RANGED in attack.factory.flags):
            battle_map = Map.get()
